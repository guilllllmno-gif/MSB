      ...
      <aside className={`flex shrink-0 flex-col overflow-y-auto overflow-x-hidden px-3 py-4 transition-[width] duration-300 ease-in-out ${collapsed ? "w-[78px]" : "w-[252px]"}`}>
        ...
        {collapsed ? (
          <div className="flex flex-col items-center gap-2.5">
            <img src={logoIcon} alt="FuturePayCA" className="h-8 w-auto" />
          ...
          <div className="flex items-center gap-2.5 px-2">
            <div className="min-w-0 flex-1">
              <img src={logoFull} alt="FuturePayCA" className="h-[26px] w-auto" />
              <div className="mt-1 truncate pl-0.5 text-[11px] leading-tight text-default-400">风控控制台</div>
            </div>
